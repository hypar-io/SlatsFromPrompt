...
namespace ImageFromPrompt
{
    public class Function
    {
        ...
        private IModelStore<ImageFromPromptInputs> store;

        public async Task<ImageFromPromptOutputs> Handler(ImageFromPromptInputs args, ILambdaContext context)
        {
            ...
            if(this.store == null)
            {
                this.store = new S3ModelStore<ImageFromPromptInputs>(RegionEndpoint.GetBySystemName("us-west-1"));
            }

            var l = new InvocationWrapper<ImageFromPromptInputs,ImageFromPromptOutputs>(store, ImageFromPrompt.Execute);
